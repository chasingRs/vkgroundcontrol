...
QQmlApplicationEngine *QGCApplication::createQmlApplicationEngine() {
    QQmlApplicationEngine *const qmlEngine = new QQmlApplicationEngine(this);
...
void QGCApplication::loadWindow() {
